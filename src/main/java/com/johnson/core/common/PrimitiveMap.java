...
public class PrimitiveMap<K extends Object> implements IPrimitiveMap<K> {
	...
	public IPrimitiveMap getMap(K key) {
		Object o = get(key.toString());
		if (o instanceof IPrimitiveMap) return (IPrimitiveMap) o;
	...
	public String getString(K key) {
		return Objects.toString(get(key.toString()));
	}
	...
	public void setObject(K key, Object value) {
		put(key.toString(), value);
	}
	...
	public String toString() {
		return "PrimitiveMap [data=" + JsonUtils.toJson(map) + "]";
	}
}
